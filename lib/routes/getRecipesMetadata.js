          ...
          if (!user) {
            ...
            async.each(recipes, (recipeObj, innerCallback) => {
              ...
              if (err) {
                ...
                let response = {
                  user: null,
                  foundRecipes: recipesMeta.length,
                  excludedRecipes: recipes.length - recipesMeta.length,
            ...
            recipeMacher(recipes, user, (err, matchedRecipes) => {
              if (err) {
                ...
                let response = {
                  ...
                  excludedRecipes: recipes.length - matchedRecipes.length,
              ...
              if (!user) {
                ...
                async.each(recipes, (recipe, callback) => {
                  ...
                  if (err) {
                    ...
                    let response = {
                      user: null,
                      foundRecipes: recipesMetadata.length,
                      excludedRecipes: recipes.length - recipesMetadata.length,
                      matchingRecipes: recipesMetadata
                    };
                    res.send(response);
                  }
                });
